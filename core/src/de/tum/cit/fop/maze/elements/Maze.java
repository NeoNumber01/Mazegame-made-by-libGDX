                ...
                for (int j = 1; j < height - 1; ++j) {
                    ...
                    switch (blockTypeCode) {
                        ...
                        case 5: // TODO: Key
                            ...
                            break;
                        case 6: // TODO: Lives
                            Lives life = new Lives(this, game.getResourcePack().getFullHeartTexture(), pos);
                            life.setScale(0.5f);
                            entities.add(life);
                            break;
                        case 7: // lIGHTING
                            Lightning lightning=new Lightning(this, game.getResourcePack().getLightingTexture(), pos);
